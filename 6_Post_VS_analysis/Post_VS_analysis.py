...
parser.add_argument('-u','--uniprot_id', help='The uniprot id of protein', required=True)
...
write_out(actives_properties,args.uniprot_id+'_actives'+'_properties_calculated')
write_out(inactives_properties,args.uniprot_id+'_inactives'+'_properties_calculated')
